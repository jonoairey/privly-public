...
export const FEATURES_LIST = [
  ...
  { emoji: '🔁', title: 'Re-emergence checks', body: "Every confirmed-removed link is rechecked on a recurring basis. The second something comes back online, we file again. Automatically." },
...
export const COMPARE_ROWS: [string, CompareCell, CompareCell, CompareCell][] = [
  ...
  ['Automated re-emergence checks', 'yes', 'no', 'no'],
...
export const FOOTER_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'JustForFans', href: '/justforfans' },
      { label: 'Loyalfans', href: '/loyalfans' },
      { label: 'Fanvue', href: '/fanvue' },
      { label: 'Fanfix', href: '/fanfix' },
  ...
  {
    heading: 'Remove from',
    /* Ordered by Google takedown volume from the Q2-2026 observatory data —
       higher-volume sites sit near the top so they pick up the most internal-link weight. */
    links: [
      { label: 'Fapello', href: '/remove-from-fapello' },
      { label: 'Nudostar', href: '/remove-from-nudostar' },
      { label: 'SpankBang', href: '/remove-from-spankbang' },
      { label: 'Coomer', href: '/remove-from-coomer' },
      { label: 'Wildskirts', href: '/remove-from-wildskirts' },
      { label: 'Leakedzone', href: '/remove-from-leakedzone' },
      { label: 'Fapodrop', href: '/remove-from-fapodrop' },
      { label: 'Eporner', href: '/remove-from-eporner' },
      { label: 'Thotsbay', href: '/remove-from-thotsbay' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Leak-site observatory', href: '/observatory' },
