...
export default function TikTokPage() {
  const canonical = `${SITE_CONFIG.url}/tiktok`;
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: "Home", url: SITE_CONFIG.url },
    { name: "Platforms", url: SITE_CONFIG.url },
    { name: "TikTok", url: canonical },
  ]);
  const productSchema = generateProductSchema({
    name: "Privly TikTok Protection",
    description:
      "Impersonation, reupload, and deepfake protection for TikTok creators. Automated takedowns and 24/7 scanning for stolen clips across social and tube platforms.",
    price: "49",
    url: canonical,
  });
        ...
        <section className="relative overflow-hidden pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Protect Your{" "}
              <span className="from-cyan-400 to-blue-400" style={{ color: 'var(--accent)' }}>
                TikTok Videos
              </span>{" "}
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="text-3xl font-bold from-cyan-400 to-blue-400" style={{ color: 'var(--accent)' }}>
                  {stat.value}
                </p>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                >
                  <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-cyan-900/30 text-cyan-600 mb-3">
                    Guide
                  </span>
            ...
            <div className="text-center mt-8">
              <Link
                href="/articles"
                className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-600 font-medium transition-colors duration-300"
              >
                View all articles
